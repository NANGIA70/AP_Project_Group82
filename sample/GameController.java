...
public class GameController implements Initializable {
    ...
    Coin coin = new Coin(0, coinImage);
    ...
    private void fall_start(int number) {
        if(number > 4) {
            return;
        }
...
//        timeline.play();
        ...
        islandsArrayList.add(new Static_Island(island5));
        islandsArrayList.add(new Static_Island(island6));
        islandsArrayList.add(new Static_Island(island7));
